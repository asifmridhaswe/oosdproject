...
@push('css')
    <link ref="stylesheet" href="https://cdn.datatables.net/1.10.16/css/dataTables.bootstrap.min.css">
@endpush
                                            ...
                                            <td>
                                                @if($reservation->status==false)
                                                    <form id="status-form-{{$reservation->id}}"
                                                          action="{{route('reservation.status',
                                                          $reservation->id)}}"
                                                    ...
                                                    <button type="button"
                                                            ...
                                                            onclick="if(confirm('Have you verified this reservation?')){
